						...
						<ul class="top-navigation">
							...
							<li class="dropdown my-account">
								...
								<div class="btn-group">
									...
									<a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="btn btn-link dropdown-toggle" data-toggle="dropdown">
										<span class="account-icon top-icon"><?php echo $text_account; ?><i class="fa fa-angle-down"></i></span>
									</a>
