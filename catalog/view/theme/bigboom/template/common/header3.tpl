...
<body class="<?php echo $class; ?>">	
	<header class="header header-2">
		<div class="container">
					...
					<div class="top-right col-sm-6">
						<ul class="top-navigation">
							...
							<li class="dropdown my-account">
								<div class="btn-group">
									<button href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="btn btn-link dropdown-toggle" data-toggle="dropdown"><a class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></a><i class="fa fa-angle-down"></i></button>
			...
			<div class="logo">
				<?php if ($logo) { ?>
					<a href="<?php echo $home3; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" /></a>
				<?php } else { ?>
					<h1><a href="<?php echo $home3; ?>"><?php echo $name; ?></a></h1>
					<?php } ?>
			</div>
