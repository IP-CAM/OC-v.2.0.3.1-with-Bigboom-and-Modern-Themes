            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>                   
                    <?php if ($layout_module['position'] == 'two_column') { ?>
                    <option value="two_column" selected="selected"><?php echo $text_two_column; ?></option>
                    <?php } else { ?>
                    <option value="two_column"><?php echo $text_two_column; ?></option>
                    <?php } ?> 
                    <?php if ($layout_module['position'] == 'three_column') { ?>
                    <option value="three_column" selected="selected"><?php echo $text_three_column; ?></option>
                    <?php } else { ?>
                    <option value="three_column"><?php echo $text_three_column; ?></option>
                    <?php } ?> 
                     <?php if ($layout_module['position'] == 'ex_position') { ?>
                    <option value="ex_position" selected="selected"><?php echo $text_ex_position; ?></option>
                    <?php } else { ?>
                    <option value="ex_position"><?php echo $text_ex_position; ?></option>
                    <?php } ?> 
                    ...
                    <?php } ?> 
                     <?php if ($layout_module['position'] == 'Threecolumns_1') { ?>
                    <option value="Threecolumns_1" selected="selected"><?php echo $text_Threecolumns_1; ?></option>
                    <?php } else { ?>
                    <option value="Threecolumns_1"><?php echo $text_Threecolumns_1; ?></option>
                    <?php } ?> 
                     <?php if ($layout_module['position'] == 'banner1') { ?>
                    <option value="banner1" selected="selected"><?php echo $text_banner1; ?></option>
                    <?php } else { ?>
...
function addModule() {
    ...
    html += '    <option value="ex_position"><?php echo $text_ex_position; ?></option>';
    html += '    <option value="two_column"><?php echo $text_two_column; ?></option>';
    html += '    <option value="three_column"><?php echo $text_three_column; ?></option>';
