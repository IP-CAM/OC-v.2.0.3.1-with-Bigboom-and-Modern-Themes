	...
	class ControllerModuleDealOfDay extends Controller{
		...
		{			
			...
			if(($this->request->server['REQUEST_METHOD']=='POST')&&$this->validate()){
				if(!isset($this->request->get['module_id'])){
					$this->model_extension_module->addModule('deal_of_day',$this->request->post);
				}
		...
		$data['breadcrumbs'] = array();
			...
			if (!isset($this->request->get['module_id'])) {
				...
				$data['breadcrumbs'][] = array(
					'text' => $this->language->get('heading_title'),
					'href' => $this->url->link('module/deal_of_day', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
				);
			}			
			...
			$data['action'] = $this->url->link('module/deal_of_day', 'token=' . $this->session->data['token'], 'SSL');
				...
				$data['action'] = $this->url->link('module/deal_of_day', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
			}
