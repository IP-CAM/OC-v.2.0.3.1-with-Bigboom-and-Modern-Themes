...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_link_footer']=$this->language->get('text_link_footer');
		$data['text_footer_contact']="Contact Info";
		...
		$data['text_cms_block']				="CMS Block";

		$data['link_cms_block']				=$this->url->link('design/cms_block','token='.$this->session->data['token'],'SSL');
		...
		$data['links_footer'] = $this->url->link('design/links_footer', 'token=' . $this->session->data['token'], 'SSL');
		$data['link_footer_contact']=$this->url->link('design/footer_contact', 'token=' . $this->session->data['token'], 'SSL');
		$data['category'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'], 'SSL');
		$data['blogs']=$this->url->link('catalog/blogs','token='.$this->session->data['token'],'SSL');
